...
|---|---|---|
| `ts/` | @voxgig-sdk/global-shark-attack-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/global-shark-attack-sdk \
      --repository voxgig-sdk/global-shark-attack-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/global-shark-attack-sdk` shows it, and
`npm trust revoke @voxgig-sdk/global-shark-attack-sdk --id=<id>` removes it.
