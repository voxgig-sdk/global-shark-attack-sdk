...
// GlobalSharkAttack SDK utility type

class GlobalSharkAttackUtility
{
    ...
    public static function copy(GlobalSharkAttackUtility $src): GlobalSharkAttackUtility
    {
        $u = new GlobalSharkAttackUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
