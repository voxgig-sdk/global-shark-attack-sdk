...
// GlobalSharkAttack SDK clienttrack feature
...
class GlobalSharkAttackClienttrackFeature extends GlobalSharkAttackBaseFeature
{
    ...
    public function PostConstruct(GlobalSharkAttackContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'GlobalSharkAttack-SDK';
