...
// GlobalSharkAttack SDK debug feature
...
class GlobalSharkAttackDebugFeature extends GlobalSharkAttackBaseFeature
{
    ...
    private function _finish(GlobalSharkAttackContext $ctx, bool $ok): void
    {
