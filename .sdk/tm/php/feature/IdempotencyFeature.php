...
// GlobalSharkAttack SDK idempotency feature
...
class GlobalSharkAttackIdempotencyFeature extends GlobalSharkAttackBaseFeature
{
    ...
    private function _mutating(GlobalSharkAttackContext $ctx): bool
    {
