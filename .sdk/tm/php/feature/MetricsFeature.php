...
// GlobalSharkAttack SDK metrics feature
...
class GlobalSharkAttackMetricsFeature extends GlobalSharkAttackBaseFeature
{
    ...
    private function _record(GlobalSharkAttackContext $ctx, bool $ok): void
    {
