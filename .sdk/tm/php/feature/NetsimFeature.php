...
// GlobalSharkAttack SDK netsim feature
...
class GlobalSharkAttackNetsimFeature extends GlobalSharkAttackBaseFeature
{
    ...
    private function _simulate(GlobalSharkAttackContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GlobalSharkAttackContext $ctx, array $applied): void
    {
        $client = $this->client;
