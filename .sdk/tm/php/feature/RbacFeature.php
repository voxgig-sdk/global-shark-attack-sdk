...
// GlobalSharkAttack SDK rbac feature
...
class GlobalSharkAttackRbacFeature extends GlobalSharkAttackBaseFeature
{
    ...
    private function _required(GlobalSharkAttackContext $ctx): ?string
    {
    ...
    private function _reject(GlobalSharkAttackContext $ctx, string $required): void
    {
    ...
    private function _track(GlobalSharkAttackContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
