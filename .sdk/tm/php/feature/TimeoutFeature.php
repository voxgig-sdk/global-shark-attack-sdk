...
// GlobalSharkAttack SDK timeout feature
...
class GlobalSharkAttackTimeoutFeature extends GlobalSharkAttackBaseFeature
{
    ...
    private function _with_timeout(GlobalSharkAttackContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GlobalSharkAttackContext $_ctx, float $ms): void
    {
        $client = $this->client;
