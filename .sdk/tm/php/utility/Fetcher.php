...
// GlobalSharkAttack SDK utility: fetcher

class GlobalSharkAttackFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GlobalSharkAttackSDK/1.0)';
    ...
    public static function call(GlobalSharkAttackContext $ctx, string $fullurl, array $fetchdef): array
    {
