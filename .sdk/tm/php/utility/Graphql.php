...
// GlobalSharkAttack SDK utility: graphql
//
...
class GlobalSharkAttackGraphql
{
    ...
    // equivalent.
    public static function body(GlobalSharkAttackContext $ctx): mixed
    {
    ...
    public static function errors(GlobalSharkAttackContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
