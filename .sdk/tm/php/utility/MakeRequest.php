...
// GlobalSharkAttack SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GlobalSharkAttackMakeRequest
{
    public static function call(GlobalSharkAttackContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GlobalSharkAttackResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GlobalSharkAttackResponse($fetched);
        } else {
