...
Results: Successful response with shark attack records.
...
| --- | --- | --- | --- |
| Analyze | `list` | `GET /analyze` | See reference |
| Download | `list` | `GET /download` | See reference |
| Search | `list` | `GET /search` | See reference |

## Connect to the API

- Production server: `https://public.opendatasoft.com/api/records/1.0`
...
- `global-shark-attack_list`: List records for an entity. Supported entities: `analyze`, `download`, `search`.
- `global-shark-attack_load`: Load one record for an entity. No active entity supports this operation.
