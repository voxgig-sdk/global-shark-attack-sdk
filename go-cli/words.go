...
func registerSDKWords(r *eng.Registry, client *sdk.GlobalSharkAttackSDK) {
...
func runOp(client *sdk.GlobalSharkAttackSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
