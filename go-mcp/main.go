// Command GlobalSharkAttack-mcp is an MCP server exposing the GlobalSharkAttack
// SDK as MCP tools.
//
// Two tools are registered:
//
//	GlobalSharkAttack_list  — list records of an entity
//	GlobalSharkAttack_load  — load a single record of an entity
//
