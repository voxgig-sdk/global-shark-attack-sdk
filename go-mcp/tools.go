...
type Args struct {
	Entity string         `json:"entity" jsonschema:"analyze | download | search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.GlobalSharkAttackSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "global-shark-attack_list",
		Description: "List records from GlobalSharkAttack. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "global-shark-attack_load",
		Description: "Load a single record from GlobalSharkAttack. " +
...
func runOp(client *sdk.GlobalSharkAttackSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.GlobalSharkAttackSDK, name string) (sdk.GlobalSharkAttackEntity, error) {
	switch strings.ToLower(name) {
	case "analyze":
		return client.Analyze(nil), nil
	case "download":
