...
type GlobalSharkAttackSDK struct {
	Mode     string
...
func (sdk *GlobalSharkAttackSDK) OptionsMap() map[string]any {
...
func (sdk *GlobalSharkAttackSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *GlobalSharkAttackSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *GlobalSharkAttackSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GlobalSharkAttackSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *GlobalSharkAttackSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *GlobalSharkAttackSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("GlobalSharkAttackSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *GlobalSharkAttackSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GlobalSharkAttackSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("GlobalSharkAttackSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *GlobalSharkAttackSDK {
	...
	sdk := NewGlobalSharkAttackSDK(sdkopts)
	sdk.Mode = "test"
