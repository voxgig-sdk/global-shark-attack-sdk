...
type AnalyzeEntity struct {
	name    string
	client  *core.GlobalSharkAttackSDK
...
func NewAnalyzeEntity(client *core.GlobalSharkAttackSDK, entopts map[string]any) *AnalyzeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AnalyzeEntity) GetName() string { return e.name }
...
func (e *AnalyzeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AnalyzeEntity) Deleted() bool {
	return e.deleted
}


func (e *AnalyzeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAnalyzeEntity(e.client, opts)
}

func (e *AnalyzeEntity) Data(args ...any) any {
...
func (e *AnalyzeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Analyze; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AnalyzeEntity) DataTyped(data ...Analyze) Analyze {
	if len(data) > 0 {
		return typedFrom[Analyze](e.Data(asMap(data[0])))
	}
	return typedFrom[Analyze](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Analyze (all fields
// optional at the wire level).
func (e *AnalyzeEntity) MatchTyped(match ...Analyze) Analyze {
	if len(match) > 0 {
		return typedFrom[Analyze](e.Match(asMap(match[0])))
	}
	return typedFrom[Analyze](e.Match())
}
...
func (e *AnalyzeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AnalyzeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AnalyzeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AnalyzeListMatch and returns []Analyze. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AnalyzeEntity) ListTyped(reqmatch AnalyzeListMatch, ctrl map[string]any) ([]Analyze, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Analyze](res), nil
}



func (e *AnalyzeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AnalyzeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AnalyzeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AnalyzeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
