...
func NewDownloadEntity(client *core.GlobalSharkAttackSDK, entopts map[string]any) *DownloadEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DownloadEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DownloadEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DownloadListMatch and returns []Download. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DownloadEntity) ListTyped(reqmatch DownloadListMatch, ctrl map[string]any) ([]Download, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Download](res), nil
}
