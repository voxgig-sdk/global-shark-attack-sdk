...
describe("AnalyzeDirect", function()
  it("should direct-list-analyze", function()
    local setup = analyze_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-analyze", setup.live and "live" or "unit")
...
function analyze_direct_setup(mockres)
