...
describe("AnalyzeEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:Analyze(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:Analyze(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set GLOBAL_SHARK_ATTACK_TEST_ANALYZE_ENTID JSON to run live")
      return
    end
...
function analyze_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("GLOBAL_SHARK_ATTACK_TEST_ANALYZE_ENTID")
