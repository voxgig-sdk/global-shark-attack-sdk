...
describe("DownloadDirect", function()
  it("should direct-list-download", function()
    local setup = download_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-download", setup.live and "live" or "unit")
