...
function runner.env_override(m)
  local live = runner.getenv("GLOBALSHARKATTACK_TEST_LIVE")
  local override = runner.getenv("GLOBALSHARKATTACK_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("GLOBALSHARKATTACK_TEST_EXPLAIN")
