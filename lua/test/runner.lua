...
function runner.env_override(m)
  local live = runner.getenv("GLOBAL_SHARK_ATTACK_TEST_LIVE")
  local override = runner.getenv("GLOBAL_SHARK_ATTACK_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("GLOBAL_SHARK_ATTACK_TEST_EXPLAIN")
