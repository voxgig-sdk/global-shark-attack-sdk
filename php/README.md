# GlobalSharkAttack PHP SDK



The PHP SDK for the GlobalSharkAttack API — an entity-oriented client using PHP conventions.
...
print_r(array_map(fn($item) => $item->data_get(), $download));
```
...
```
php/
├── globalsharkattack_sdk.php          -- Main SDK class
...
The main class (`globalsharkattack_sdk.php`) exports the SDK class
