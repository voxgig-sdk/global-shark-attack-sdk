...
The PHP SDK for the GlobalSharkAttack API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Analyze(null)->list(null, null);
...
[$result, $err] = $client->GlobalSharkAttack(null)->load(
    ["id" => "test01"], null
);
