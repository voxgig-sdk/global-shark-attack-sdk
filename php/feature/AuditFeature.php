...
// GlobalSharkAttack SDK audit feature
...
class GlobalSharkAttackAuditFeature extends GlobalSharkAttackBaseFeature
{
    ...
    private function _emit(GlobalSharkAttackContext $ctx, string $outcome): void
    {
