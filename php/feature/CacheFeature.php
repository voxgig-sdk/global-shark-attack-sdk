...
// GlobalSharkAttack SDK cache feature
...
class GlobalSharkAttackCacheFeature extends GlobalSharkAttackBaseFeature
{
    ...
    private function _through(GlobalSharkAttackContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
