...
// GlobalSharkAttack SDK paging feature
...
class GlobalSharkAttackPagingFeature extends GlobalSharkAttackBaseFeature
{
    ...
    private function _is_list(GlobalSharkAttackContext $ctx): bool
    {
