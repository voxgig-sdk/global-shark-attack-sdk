...
// GlobalSharkAttack SDK proxy feature
...
class GlobalSharkAttackProxyFeature extends GlobalSharkAttackBaseFeature
{
    ...
    public function init(GlobalSharkAttackContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GlobalSharkAttackContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
