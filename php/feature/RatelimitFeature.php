...
// GlobalSharkAttack SDK ratelimit feature
...
class GlobalSharkAttackRatelimitFeature extends GlobalSharkAttackBaseFeature
{
    ...
    private function _acquire(GlobalSharkAttackContext $ctx): void
    {
    ...
    private function _track(GlobalSharkAttackContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
