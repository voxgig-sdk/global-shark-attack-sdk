...
// GlobalSharkAttack SDK streaming feature
...
class GlobalSharkAttackStreamingFeature extends GlobalSharkAttackBaseFeature
{
    ...
    private function _iterate(GlobalSharkAttackResult $result): \Generator
    {
    ...
    private function _streamable(GlobalSharkAttackContext $ctx): bool
    {
