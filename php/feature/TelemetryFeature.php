...
// GlobalSharkAttack SDK telemetry feature
...
class GlobalSharkAttackTelemetryFeature extends GlobalSharkAttackBaseFeature
{
    ...
    private function _close(GlobalSharkAttackContext $ctx, bool $ok): void
    {
