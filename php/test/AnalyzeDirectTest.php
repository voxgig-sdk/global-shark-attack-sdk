...
class AnalyzeDirectTest extends TestCase
{
    public function test_direct_list_analyze(): void
    {
        $setup = analyze_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-analyze", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
