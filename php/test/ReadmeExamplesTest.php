...
// GlobalSharkAttack SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GlobalSharkAttackSDK::test)
...
{
    private const SDK_CLASS = 'GlobalSharkAttackSDK';
    ...
    private const SDK_BASE = 'globalsharkattack_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../globalsharkattack_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
