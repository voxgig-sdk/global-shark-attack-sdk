...
// GlobalSharkAttack SDK utility: make_options

class GlobalSharkAttackMakeOptions
{
    ...
    public static function call(GlobalSharkAttackContext $ctx): array
    {
        ...
        //
        // `GlobalSharkAttackSchema::optspec()` is built from the model:
        ...
        $optspec = GlobalSharkAttackSchema::optspec();
