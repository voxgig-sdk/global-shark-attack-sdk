# GlobalSharkAttack Python SDK



The Python SDK for the GlobalSharkAttack API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Analyze()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/global-shark-attack-sdk/releases)) or
...
client = GlobalSharkAttackSDK(options)
```
...
```
py/
├── globalsharkattack_sdk.py         -- Main SDK module
