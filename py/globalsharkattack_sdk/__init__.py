...
from globalsharkattack_sdk.utility import register

# Load features
from globalsharkattack_sdk.feature.base_feature import GlobalSharkAttackBaseFeature
from globalsharkattack_sdk.features import _has_feature, _make_feature
...
class GlobalSharkAttackSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = GlobalSharkAttackUtility()
    ...
    def get_utility(self):
        return GlobalSharkAttackUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GlobalSharkAttackSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Analyze(self, data=None) -> "AnalyzeEntity":
        ...
        from globalsharkattack_sdk.entity.analyze_entity import AnalyzeEntity
    ...
    def Download(self, data=None) -> "DownloadEntity":
        ...
        from globalsharkattack_sdk.entity.download_entity import DownloadEntity
        return DownloadEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from globalsharkattack_sdk.entity.search_entity import SearchEntity
