# GlobalSharkAttack SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GlobalSharkAttackSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GlobalSharkAttackSDK(...) and GlobalSharkAttackSDK.test(...) become
#      GlobalSharkAttackSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "globalsharkattack_sdk"
_SDK_CLASS = "GlobalSharkAttackSDK"
