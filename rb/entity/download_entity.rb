...
class DownloadEntity
  ...
  #
  # @param reqmatch [DownloadListMatch, Hash, nil] match filter (any subset of
  #   Download fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Download>, Array] the matching Download items; raises GlobalSharkAttackError on failure
