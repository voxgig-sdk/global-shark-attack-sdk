...
#      offline in seeded test mode (GlobalSharkAttackSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "GlobalSharkAttack_sdk.rb")
  SDK_CLASS = "GlobalSharkAttackSDK"
  ...
  SDK_BASE = "GlobalSharkAttack_sdk"
