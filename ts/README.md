# GlobalSharkAttack TypeScript SDK



The TypeScript SDK for the GlobalSharkAttack API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Analyze()` — each with a small set of operations (`list`)
...
| `tester(testopts?, sdkopts?)` | `GlobalSharkAttackSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `GlobalSharkAttackSDK.test(testopts?, sdkopts?)` | `GlobalSharkAttackSDK` | Create a test-mode client. |
...
| `client` | `client(): GlobalSharkAttackSDK` | Return the parent SDK client. |
...
global-shark-attack/
├── src/
│   ├── GlobalSharkAttackSDK.ts        # Main SDK class
