...
(0, node_test_1.describe)('AnalyzeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-analyze', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-analyze', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GLOBAL_SHARK_ATTACK_TEST_ANALYZE_ENTID'];
...
//# sourceMappingURL=AnalyzeDirect.test.js.map