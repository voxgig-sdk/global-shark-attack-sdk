...
(0, node_test_1.describe)('DownloadDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.GlobalSharkAttackSDK({
    ...
    (0, node_test_1.test)('direct-list-download', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-download', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        if (setup.live) {
            query.dataset = "global-shark-attack";
        }
...
function liveScenariosActive() { return false && process.env.GLOBAL_SHARK_ATTACK_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.GlobalSharkAttackSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['GLOBAL_SHARK_ATTACK_TEST_DOWNLOAD_ENTID'];
    ...
    const client = new __1.GlobalSharkAttackSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=DownloadDirect.test.js.map