...
function envOverride(m) {
    if ('TRUE' === process.env.GLOBAL_SHARK_ATTACK_TEST_LIVE ||
        'TRUE' === process.env.GLOBAL_SHARK_ATTACK_TEST_OVERRIDE) {
    ...
    m.GLOBAL_SHARK_ATTACK_TEST_EXPLAIN = process.env.GLOBAL_SHARK_ATTACK_TEST_EXPLAIN || m.GLOBAL_SHARK_ATTACK_TEST_EXPLAIN;
    return m;
}
